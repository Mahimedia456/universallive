...
Write-Host '=== UniversalLive Backend Batch 06 — Phase 15/16/17/18 ===' -ForegroundColor Cyan

$backup = "$appModule.backend-batch06.bak"
...
Add-NestModule -ModuleName 'EntitlementsModule' -ImportLine "import { EntitlementsModule } from './entitlements/entitlements.module';"
Add-NestModule -ModuleName 'BillingModule' -ImportLine "import { BillingModule } from './billing/billing.module';"
Add-NestModule -ModuleName 'NotificationsV2Module' -ImportLine "import { NotificationsV2Module } from './notifications-v2/notifications-v2.module';"
Add-NestModule -ModuleName 'SupportV2Module' -ImportLine "import { SupportV2Module } from './support-v2/support-v2.module';"
...
Write-Host ''
Write-Host 'BACKEND BATCH 06 BUILD SUCCESSFUL' -ForegroundColor Green
