...
Write-Host '=== UniversalLive Backend Batch 04 — Phase 08/09/10 ===' -ForegroundColor Cyan

$backup = "$appModule.backend-batch04.bak"
...
# Keep cumulative registrations safe.
Add-NestModule `
...
Add-NestModule `
    -ModuleName 'ScenesV2Module' `
    -ImportLine "import { ScenesV2Module } from './scenes-v2/scenes-v2.module';"

Add-NestModule `
    -ModuleName 'SceneSourcesModule' `
    -ImportLine "import { SceneSourcesModule } from './scene-sources/scene-sources.module';"

Add-NestModule `
    -ModuleName 'AssetsV2Module' `
    -ImportLine "import { AssetsV2Module } from './assets-v2/assets-v2.module';"
...
Write-Host ''
Write-Host 'BACKEND BATCH 04 BUILD SUCCESSFUL' -ForegroundColor Green
